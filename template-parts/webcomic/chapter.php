...
<head>
    ...
    <meta property="og:title" content="<?= the_title() ?> | <?= $curr_chapter['chapter_title']; ?>">
    <meta property="og:image" content="<?= ( ! empty( get_field( 'banner_image' ) ) ) ? get_field( 'banner_image' )['url'] : $sticky_header_logo ?>">
